  ...
  extends RulesEngineTestBase
{
    ...
    throws Exception
  {
    ...
    assertQ(req(new String[] { "qt", "/lucidRules", "q", "id:0" }), new String[] { "//*[@numFound='1']", "//str[@name='hello'][.='world']", "//str[@name='good'][.='bye']", "//str[@name='first'][.='prepare']", "//str[@name='first'][.='process']", "not(//str[@name='first'][.='finish'])" });
    ...
    assertQ(req(new String[] { "qt", "/lucidRules", "q", "id:0", "rules.first", "false", "rules.mock", "false" }), new String[] { "//*[@numFound='1']", "not(//str[@name='hello'][.='world'])", "//str[@name='good'][.='bye']", "not(//str[@name='first'][.='prepare'])", "not(//str[@name='first'][.='process'])" });
    ...
    assertQ(req(new String[] { "qt", "/lucidRules", "q", "id:0", "rules.prepare", "true", "rules.process", "false", "first", "true" }), new String[] { "//*[@numFound='1']", "//str[@name='hello'][.='world']", "//str[@name='good'][.='bye']", "//str[@name='first'][.='prepare']", "not(//str[@name='first'][.='process'])" });
    ...
    assertQ(req(new String[] { "qt", "/lucidRules", "q", "id:0", "rules.prepare", "false", "rules.process", "true", "first", "true" }), new String[] { "//*[@numFound='1']", "//str[@name='hello'][.='world']", "//str[@name='good'][.='bye']", "not(//str[@name='first'][.='prepare'])", "//str[@name='first'][.='process']" });
    ...
    throws Exception
  {
    ...
    assertNotNull("Handler doesn't exist", handler);
    RulesEngine mock = handler.getEngine("mock");
    assertTrue("mock is null and it shouldn't be", mock != null);
    assertQ(req(new String[] { "qt", "/lucidRules", "q", "id:0" }), new String[] { "//*[@numFound='1']", "//str[@name='hello'][.='world']", "//str[@name='mock'][.='fact']" });
  }
}
